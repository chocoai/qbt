        ...
        getImg: function () {
            ...
            $.commonAjax({
                ...
                success: function (data) {
                    if (data.datas && data.datas.imageVoList && data.datas.imageVoList.length > 0) {
        ...
        showPopup: function (reminderId) {
            ...
            for (var key in reminders) {
                ...
                if (row.id === reminderId) {
                    ...
                    if (row.detailImage && row.detailImage.trim() != "") {
                        type = 1;
                    }
                    if (type == 2) {
                        layer.open({
                    ...
                    if (type == 1) {
                        layer.open({
                            // title: row.name,
                            content: "<img src='" + $.fbaseUrl+row.detailImage + "'>",
                            btn: '确定',
                            shadeClose: true,
                            className: 'layer_alert_home_image',
