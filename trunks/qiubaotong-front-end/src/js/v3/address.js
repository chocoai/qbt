var home_address_view = Vue.extend({
    ...
    methods: {
        goView: function (type) {
            ...
            //历史地址
            if (type == 4) {
                router.push('/isend/address/addrs_his');
            } else if (type == 2) {//球场
                router.push('/isend/address/addrs_course');
            } else if (type == 1) {//输入地址
        ...
        save: function () {
            ...
            //输入地址
            if (_this.tab == 1 || _this.tabStyle == 1) {
                addr_type = 4;
                $.commonAjax({
            ...
            var attr_msg = {
                ...
                real_address: '',
                treePath: this.tab == 1 || _this.tabStyle == 1 ? str : '',
                areaId: this.tab == 1 || _this.tabStyle == 1 ? this.cityName[2] : this.addrMsg.areaId,
                addr_type: addr_type,
                addr_id: this.tab != 1 || _this.tabStyle != 1 ? this.addrMsg.id : '',
                remark: '',
    ...
    activated: function () {
        ...
        else if (self.route_ident == '#addrs_his') {
            console.log(self.addrMsg);
