...
.controller('bankBranchesCheckDetailCtrl',['$scope','$http','CommonService',function($scope,$http,CommonService){
    ...
    $scope.getList = function(id){
       CommonService.httpRequest({
            url : '/baseBankBranch/findById.api',
            method : 'get',
            data : {
                id : id
            }
        ...
        if(!id){
             CommonService.httpRequest({
                ...
                showInfo("新增成功",function(){
                    tabOpenParent({name:'bankBranchesCheck',url:'bankBranchesCheck.html',displayName:'银行网点'});
                });
            });
        }
        else{
            CommonService.httpRequest({
                url : '/baseBankBranch/updateById.api',
                method : 'post',
                data :{
                    id:$scope.id,
                    name : $scope.name,
