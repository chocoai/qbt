            ...
            $.ajax({
                ...
                success : function(data){
                    if(data.code == '0000'){
                        ...
                        _this.expect_time = data.datas[0];
                        var _html='';
                        data.datas[0].origin_price>data.datas[0].sf_price && (_html='<s style="padding-left:15px">原价:'+currency(data.datas[0].origin_price,'￥')+'</s>');
                        $('#deliverTitle').html(data.datas[0].deliver_time.split(',')[1] + ' ' + currency(data.datas[0].sf_price,'￥')+_html);
                    }else{
                        layer.msg(data.msg);
                    }
                },
