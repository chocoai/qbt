...
;(function($){
    ...
    //添加滚动事件监听 IOS微信浏览到底部再上拉的时候fixed的内容会不见
    ...
    //     //alert(scrollTop+","+offsetHeight+","+scrollHeight);
    //     if (scrollTop + offsetHeight > scrollHeight) {
    //         //alert("11");
    //         // 已经滚到底部了只能向上滚动
    //         $(".footer-ios").css({'position': 'absolute'});
    //     }else {
    //         $(".footer-ios").css({'position': 'fixed'});
    //     }
    //
    //     //alert(scrollHeight+","+window_height);
...
;(function($){
    ...
    $.weixinAuth = function(){
    	...
    	if(!token){
            ...
            //var code="071qAT3C1dKRl20bvE3C1sLW3C1qAT3l";
    		if(code == null){
