...
(function ($) {
  ...
  @@include('v3/agent_addrs_his.js')
  @@include('v3/agent_addrs_course.js')
  ...
  var router = new VueRouter({
    routes: [
      ...
      {path : '/agent_address/addrs_his' ,component : agent_address_his_select_view},
      {path : '/agent_address/addrs_course' ,component : agent_address_course_select_view},
