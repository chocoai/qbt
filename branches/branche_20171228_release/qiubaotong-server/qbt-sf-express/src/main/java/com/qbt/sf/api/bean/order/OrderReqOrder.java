...
public class OrderReqOrder {
    ...
    private List<OrderAddedService> addedService;
    ...
    */
     ...
     */
    public List<OrderCargo> getCargoList() {
        return cargoList;
    }
    ...
    */
    public void setCargoList(List<OrderCargo> cargoList) {
     ...
     */
    public List<OrderAddedService> getAddedService() {
        return addedService;
    }
    ...
    */
    public void setAddedService(List<OrderAddedService> addedService) {
