...
public interface OrderInfoMapper {
	 ...
	 * @return
	 */
	List<BossOrderInfo> findByPageBossNew(@Param("condition")BossOrderInfo condition,@Param("limitIndex")int limitIndex,@Param("limitSize")int limitSize,@Param("orderByColumn")String orderByColumn,@Param("orderByType")String orderByType);
	/**
	 * 获取Boss分页查询总记录数
	 * @param condition
	 * @return
	 */
	int findByPageBossNewCount(@Param("condition")BossOrderInfo condition);
