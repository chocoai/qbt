...
public class UserActivityOrderDetail extends BaseEntity {
	int userId;
	int orderId;
	Integer type;
	Date expirationTime;
	...
	Integer activeStatus; //(0 - inactive; 1 - active)
	Integer packageType; //(0 - self use ; 1 - share to others but not accept;2 - accepted; 3 - shared)
	String qrCode;
	Integer operatorId;
	String operatorName;
