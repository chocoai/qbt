...
public class ReminderSupportImpl implements ReminderSupport {
	...
	@Override
	public boolean update(ReminderVo vo) {
		...
		reminder.setName(vo.getName());
		reminder.setDescription(vo.getDescription());
		reminder.setImage(vo.getImage());
		reminder.setStatus(vo.getStatus());
		reminder.setOrderNumber(vo.getOrderNumber());
		reminder.setComments(vo.getComments());
		reminder.setDetailImage(vo.getDetailImage());
