...
@XmlType(propOrder = {})  
public class OrderReverseResp { 
    @XmlAttribute
    private String  service="OrderReverseService";
	...
	@XmlElement(name="OrderReverseResponse")
    private List<OrderReverseRespDeliver> deliverOrder;
	...
	public List<OrderReverseRespDeliver> getDeliverOrder() {
		return deliverOrder;
	}


	public void setDeliverOrder(List<OrderReverseRespDeliver> deliverOrder) {
