...
@@include('v3/voucher_my.js')
@@include('v3/voucher_buy.js')
@@include('v3/voucher_agreement.js')
@@include('v3/ball_bag_photo.js')
...
var router = new VueRouter({
    routes: [
        ...
        // 代金券路由
        {path : '/send/voucher_my' ,component : voucher_my_view},
        // 购买券包路由
        {path : '/send/voucher_buy' ,component : voucher_buy_view},
        // 券包协议路由
        {path : '/send/voucher_agreement' ,component : voucher_agreement_view},
        // 券包球包图片路由
        {path : '/send/ball_bag_photo' ,component : ball_bag_photo_view},
